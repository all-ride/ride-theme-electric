...
<!--[if gt IE 9]><!--> <html class="no-js" lang="{$app.locale}"> <!--<![endif]-->
    <head>
        {block name="head"}
            ...
            {/block}
            {block name="styles"}
                <!--[if gt IE 8]><!--><link rel="stylesheet" href="{$app.url.base}/electric/css/main.min.css"> <!--<![endif]-->
                <!--[if lt IE 9]><link rel="stylesheet" href="{$app.url.base}/electric/css/main-legacy.min.css"><![endif]-->
                <!--[if gt IE 8]><!--><link rel="stylesheet" href="{$app.url.base}/electric/css/custom.min.css"> <!--<![endif]-->
                <!--[if lt IE 9]><link rel="stylesheet" href="{$app.url.base}/electric/css/custom-legacy.min.css"><![endif]-->
            {/block}
            ...
            {block name="styles_app"}
                ...
                {if isset($app.styles)}
                    {foreach $app.styles as $style => $null}
                        ...
                        {else}
                            <link href="{$app.url.base}/electric/{$style}" rel="stylesheet" media="screen">
                        {/if}
                    {/foreach}
                {/if}
                {if $customCSS}
            ...
            {block name="head_scripts"}
                <script type="text/javascript" src="{$app.url.base}/electric/js/modernizr.min.js"></script>
                <!--[if lt IE 9]><script type="text/javascript" src="{$app.url.base}/electric/js/polyfill.min.js"></script><![endif]-->
                {literal}
...
{block name="body"}
    ...
    {/block}
    {block name="scripts"}
        <script src="{$app.url.base}/electric/js/jquery.min.js"></script>
        <script type="text/javascript">
        ...
        <script type="text/javascript" src="{$app.url.base}/electric/js/main.min.js"></script>
        <script type="text/javascript" src="{$app.url.base}/electric/js/ajax.js"></script>
    {/block}
    ...
    {if isset($app.javascripts)}
        ...
        <script src="{$app.url.base}/electric/{$script}"></script>
            {/if}
        {/foreach}
    {/if}
