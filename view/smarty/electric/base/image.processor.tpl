...
{block name="styles" append}
    <link rel="stylesheet" type="text/css" href="{$app.url.base}/electric/css/imgareaselect-animated.css">
{/block}

{block name="scripts" append}
    <script src="{$app.url.base}/electric/js/jquery.imgareaselect.pack.js"></script>
