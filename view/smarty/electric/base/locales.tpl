...
{block name="content" append}
    ...
    {foreach $locales as $locale}
        ...
        <div class="locale locale-{$code}" id="locales-{$code}">
            ...
            <div class="btn-group">
                <a class="btn btn--default" href="{url id="system.translations.locale" parameters=["locale" => $code]}?referer={htmlspecialchars($app.url.request)}">{translate key="button.translations.manage"}</a>
            {if $properties}
...
{block name="scripts" append}
    <script src="{$app.url.base}/electric/js/locales.js"></script>
{/block}
