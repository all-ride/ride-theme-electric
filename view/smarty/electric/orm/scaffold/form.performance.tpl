        ...
        <div class="form__group row-date">
            <div class="form__group">
                ...
                <div class="form__item">
                    ...
                    <span class="until">&nbsp;{strtolower("label.until"|translate)}&nbsp;</span>
                {if $allowPeriod}
        ...
        <div class="repeater">
            <div class="form__group row-step">
                ...
                <div class="form__group">
                    ...
                    &nbsp;{strtolower("label.event.every"|translate)}&nbsp;
                    {call formWidget form=$form row=$form->getRow('date')->getRow('step')}
                    <span class="step step-daily">{strtolower("label.days"|translate)}</span>
                    <span class="step step-weekly">{strtolower("label.weeks"|translate)}</span>
                    <span class="step step-monthly">{strtolower("label.months"|translate)}</span>
                    <span class="step step-yearly">{strtolower("label.years"|translate)}</span>
                </div>
                <div class="form__group">
...
{block name="scripts" append}
    ...
    <script src="{$app.url.base}/electric/js/calendar.js"></script>
{/block}
